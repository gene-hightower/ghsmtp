...
Mailbox-test_STEMS := DNS Domain IP4 IP6
Message-test_STEMS := DNS Domain IP4 IP6 Message Pill
...
Sock-test_STEMS := POSIX Sock SockBuffer TLS-OpenSSL
SockBuffer-test_STEMS := POSIX Sock SockBuffer TLS-OpenSSL
