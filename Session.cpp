...
bool ip4_whitelisted(char const* addr)
{
  ...
  nw const networks[]{
    ...
    {"40.76.0.0",       "255.252.0.0",     "40.76.0.0/14 NET-40-74-0-0-1"},
    {"40.112.0.0",      "255.248.0.0",     "40.112.0.0/13 NET-40-74-0-0-1"},
    {"40.124.0.0",      "255.255.0.0",     "40.124.0.0/16 NET-40-74-0-0-1"},
    {"40.125.0.0",      "255.255.128.0",   "40.125.0.0/17 NET-40-74-0-0-1"},
    {"40.74.0.0",       "255.254.0.0",     "40.74.0.0/15 NET-40-74-0-0-1"},
    {"40.96.0.0",       "255.240.0.0",     "40.96.0.0/12 NET-40-74-0-0-1"},
    {"40.120.0.0",      "255.252.0.0",     "40.120.0.0/14 NET-40-74-0-0-1"},
    {"40.80.0.0",       "255.240.0.0",     "40.80.0.0/12 NET-40-74-0-0-1"},
